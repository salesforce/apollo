...
public class ApolloConfiguration {
    ...
    public static class SimCommunicationsFactory implements CommunicationsFactory {
        ...
        public static final AvalancheLocalCommSim AVALANCHE_LOCAL_COMM = new AvalancheLocalCommSim();
        public static final FfLocalCommSim FF_LOCAL_COM = new FfLocalCommSim();
        public static final GhostLocalCommSim GHOST_LOCAL_COMM = new GhostLocalCommSim();
