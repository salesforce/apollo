...
public class CrlDistPointExtension extends CertExtension {
    ...
    public static CrlDistPointExtension create(final DistributionPointName distributionPoint, final ReasonFlags reasons,
    ...
    public static CrlDistPointExtension create(final NameType distribPointNameType, final String distribPointName,
                                               final NameType crlIssuerNameType, final String crlIssuer,
    ...
    /**
     * Creates a {@link CrlDistPointExtension} with only a {@code distributionPoint}
     * URI (no {@code reasons}, no {@code cRLIssuer} specified).
     */
