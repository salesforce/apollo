...
/**
 * The subclass of {@link SQLException} thrown when an error occurs during a
 * batch update operation. In addition to the information provided by
 * {@link SQLException}, a <code>BatchUpdateException</code> provides the update
 * counts for all commands that were executed successfully during the batch
 * update, that is, all commands that were executed before the error occurred.
 * The order of elements in an array of update counts corresponds to the order
 ...
 * <p>
 * If {@code Statement.executeLargeBatch} method is invoked it is recommended
 * that {@code getLargeUpdateCounts} be called instead of
 * {@code getUpdateCounts} in order to avoid a possible overflow of the integer
 * update count.
 * 
 * @since 1.2
 */
...
public class BatchUpdateException extends SQLException {
     ...
     * given <code>reason</code>, <code>SQLState</code>, <code>vendorCode</code> and
     * <code>updateCounts</code>. The <code>cause</code> is not initialized, and may
     * subsequently be initialized by a call to the
     ...
     *                     command in the batch for JDBC drivers that continue
     *                     processing after a command failure; an update count or
     *                     <code>Statement.SUCCESS_NO_INFO</code> for each SQL
     *                     command in the batch prior to the failure for JDBC
     *                     drivers that stop processing after a command failure
     * @since 1.2
     ...
     * <code>updateCounts</code>. The <code>cause</code> is not initialized, and may
     * subsequently be initialized by a call to the
     * {@link Throwable#initCause(java.lang.Throwable)} method. The vendor code is
     * initialized to 0.
     * <p>
     * <strong>Note:</strong> There is no validation of {@code updateCounts} for
     * overflow and because of this it is recommended that you use the constructor
    ...
    /**
     * Constructs a <code>BatchUpdateException</code> object initialized with a
     * given <code>reason</code> and <code>updateCounts</code>. The
     * <code>cause</code> is not initialized, and may subsequently be initialized by
     * a call to the {@link Throwable#initCause(java.lang.Throwable)} method. The
     * <code>SQLState</code> is initialized to <code>null</code> and the vendor code
     * is initialized to 0.
     * <p>
     * <strong>Note:</strong> There is no validation of {@code updateCounts} for
     * overflow and because of this it is recommended that you use the constructor
    ...
    /**
     * Constructs a <code>BatchUpdateException</code> object initialized with a
     * given <code>updateCounts</code>. initialized by a call to the
     * {@link Throwable#initCause(java.lang.Throwable)} method. The
     * <code>reason</code> and <code>SQLState</code> are initialized to null and the
    ...
    /**
     * Constructs a <code>BatchUpdateException</code> object. The
     * <code>reason</code>, <code>SQLState</code> and <code>updateCounts</code> are
     * initialized to <code>null</code> and the vendor code is initialized to 0. The
     * <code>cause</code> is not initialized, and may subsequently be initialized by
     * a call to the {@link Throwable#initCause(java.lang.Throwable)} method.
     *
     * @since 1.2
     * @see #BatchUpdateException(java.lang.String, java.lang.String, int, long[],
     *      java.lang.Throwable)
    ...
    /**
     * Constructs a <code>BatchUpdateException</code> object initialized with a
     * given <code>cause</code>. The <code>SQLState</code> and
     * <code>updateCounts</code> are initialized to <code>null</code> and the vendor
     * code is initialized to 0. The <code>reason</code> is initialized to
    ...
    public BatchUpdateException(Throwable cause) {
        this((cause == null ? null : String.toDJVM(cause.toString())), null, 0, (int[]) null, cause);
    }

    /**
     * Constructs a <code>BatchUpdateException</code> object initialized with a
     * given <code>cause</code> and <code>updateCounts</code>. The
     * <code>SQLState</code> is initialized to <code>null</code> and the vendor code
     * is initialized to 0. The <code>reason</code> is initialized to
     * <code>null</code> if <code>cause==null</code> or to
     * <code>cause.toString()</code> if <code>cause!=null</code>.
     * <p>
     * <strong>Note:</strong> There is no validation of {@code updateCounts} for
    ...
    public BatchUpdateException(int[] updateCounts, Throwable cause) {
        this((cause == null ? null : String.toDJVM(cause.toString())), null, 0, updateCounts, cause);
    }

    /**
     * Constructs a <code>BatchUpdateException</code> object initialized with a
     * given <code>reason</code>, <code>cause</code> and <code>updateCounts</code>.
     * The <code>SQLState</code> is initialized to <code>null</code> and the vendor
    ...
    /**
     * Constructs a <code>BatchUpdateException</code> object initialized with a
     * given <code>reason</code>, <code>SQLState</code>,<code>cause</code>, and
     ...
     *                     {@code updateCounts} for overflow and because of this it
     ...
     * executed successfully before this exception occurred. A driver that
     * implements batch updates may or may not continue to process the remaining
     * commands in a batch when one of the commands fails to execute properly. If
     * the driver continues processing commands, the array returned by this method
     * will have as many elements as there are commands in the batch; otherwise, it
     * will contain an update count for each command that executed successfully
     * before the <code>BatchUpdateException</code> was thrown.
     * <P>
     ...
     *         updates that were executed successfully before this error occurred.
     *         Or, if the driver continues to process commands after an error, one
     *         of the following for every command in the batch:
     *         <OL>
     *         <LI>an update count
     ...
     *
     * @return an array of <code>long</code> containing the update counts for the
     *         updates that were executed successfully before this error occurred.
     *         Or, if the driver continues to process commands after an error, one
     *         of the following for every command in the batch:
     *         <OL>
    ...
    /*
     * Starting with Java SE 8, JDBC has added support for returning an update count
     * > Integer.MAX_VALUE. Because of this the following changes were made to
     * BatchUpdateException: <ul> <li>Add field longUpdateCounts</li> <li>Add
     * Constructor which takes long[] for update counts</li> <li>Add
     * getLargeUpdateCounts method</li> </ul> When any of the constructors are
     * called, the int[] and long[] updateCount fields are populated by copying the
     * one array to each other.
     *
     ...
     *
     * JDBC drivers should always use the constructor that specifies long[] and JDBC
     * application developers should call getLargeUpdateCounts.
     */
    ...
    /*
     * Utility method to copy long[] updateCount to int[] updateCount. No checks for
     * overflow will be done as it is expected a user will call
    ...
    /**
     * readObject is called to restore the state of the {@code BatchUpdateException}
     * from a stream.
     */
