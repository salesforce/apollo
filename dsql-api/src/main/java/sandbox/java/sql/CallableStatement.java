 ...
 * in a standard way for all RDBMSs. This escape syntax has one form that
 * includes a result parameter and one that does not. If used, the result
 * parameter must be registered as an OUT parameter. The other parameters can be
 * used for input, output or both. Parameters are referred to sequentially, by
 ...
 * {@link PreparedStatement}. The type of all OUT parameters must be registered
 * prior to executing the stored procedure; their values are retrieved after
 * execution via the <code>get</code> methods provided here.
 * <P>
...
public interface CallableStatement extends PreparedStatement {
     ...
     * <code>sandbox.java.sql.Types.OTHER</code>. The method {@link #getObject}
     * retrieves the value.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     * @param sqlType        the JDBC type code defined by
     *                       <code>sandbox.java.sql.Types</code>. If the parameter
     *                       is of JDBC type <code>NUMERIC</code> or
     *                       <code>DECIMAL</code>, the version of
     *                       <code>registerOutParameter</code> that accepts a scale
     *                       value should be used.
     *
     * @exception SQLException                    if the parameterIndex is not
     *                                            valid; if a database access error
     *                                            occurs or this method is called on
     *                                            a closed
     *                                            <code>CallableStatement</code>
     * @exception SQLFeatureNotSupportedException if <code>sqlType</code> is a
     *                                            <code>ARRAY</code>,
     *                                            <code>BLOB</code>,
     *                                            <code>CLOB</code>,
     *                                            <code>DATALINK</code>,
     ...
     * of JDBC type <code>sqlType</code>. All OUT parameters must be registered
     * before a stored procedure is executed.
     * <p>
     * The JDBC type specified by <code>sqlType</code> for an OUT parameter
     * determines the Java type that must be used in the <code>get</code> method to
     ...
     *                       <code>sandbox.java.sql.Types</code>.
     ...
     * object returned has exactly the same value the SQL <code>CHAR</code> value
    ...
    /**
     * Retrieves the value of the designated JDBC <code>BIT</code> or
     * <code>BOOLEAN</code> parameter as a <code>boolean</code> in the Java
     ...
     * <code>sandbox.java.sql.Date</code> object.
     * 
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     * @return the parameter value. If the value is SQL <code>NULL</code>, the
     *         result is <code>null</code>.
     ...
     * @see #setDate
     */
    sandbox.java.sql.Date getDate(int parameterIndex) throws SQLException;

    /**
     * Retrieves the value of the designated JDBC <code>TIME</code> parameter as a
     * <code>sandbox.java.sql.Time</code> object.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     * @return the parameter value. If the value is SQL <code>NULL</code>, the
     *         result is <code>null</code>.
     ...
     * @see #setTime
     */
    sandbox.java.sql.Time getTime(int parameterIndex) throws SQLException;

    /**
     * Retrieves the value of the designated JDBC <code>TIMESTAMP</code> parameter
     * as a <code>sandbox.java.sql.Timestamp</code> object.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     * @return the parameter value. If the value is SQL <code>NULL</code>, the
     *         result is <code>null</code>.
     ...
     * @see #setTimestamp
     */
    sandbox.java.sql.Timestamp getTimestamp(int parameterIndex) throws SQLException;
     ...
     * <code>sandbox.java.sql.Types.OTHER</code>, this method can be used to read
     ...
     * <code>parameterIndex</code> and uses <code>map</code> for the custom mapping
     ...
     * {@link sandbox.java.sql.Ref} object in the Java programming language.
     * 
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     ...
     * {@link sandbox.java.sql.Blob} object in the Java programming language.
     * 
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     ...
     * <code>sandbox.java.sql.Clob</code> object in the Java programming language.
     * 
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     ...
     * {@link sandbox.java.sql.Array} object in the Java programming language.
     * 
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
    ...
    /**
     * Retrieves the value of the designated JDBC <code>DATE</code> parameter as a
     * <code>sandbox.java.sql.Date</code> object, using the given
     * <code>Calendar</code> object to construct the date. With a
     * <code>Calendar</code> object, the driver can calculate the date taking into
     * account a custom timezone and locale. If no <code>Calendar</code> object is
     ...
     * @since 1.2
     */
    sandbox.java.sql.Date getDate(int parameterIndex, Calendar cal) throws SQLException;

    /**
     * Retrieves the value of the designated JDBC <code>TIME</code> parameter as a
     * <code>sandbox.java.sql.Time</code> object, using the given
     * <code>Calendar</code> object to construct the time. With a
     * <code>Calendar</code> object, the driver can calculate the time taking into
     * account a custom timezone and locale. If no <code>Calendar</code> object is
     * specified, the driver uses the default timezone and locale.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     ...
     * @since 1.2
     */
    sandbox.java.sql.Time getTime(int parameterIndex, Calendar cal) throws SQLException;

    /**
     * Retrieves the value of the designated JDBC <code>TIMESTAMP</code> parameter
     * as a <code>sandbox.java.sql.Timestamp</code> object, using the given
     ...
     * @since 1.2
     */
    sandbox.java.sql.Timestamp getTimestamp(int parameterIndex, Calendar cal) throws SQLException;
     ...
     * <p>
     * For a user-defined parameter, the fully-qualified SQL type name of the
     * parameter should also be given, while a <code>REF</code> parameter requires
     * that the fully-qualified type name of the referenced type be given. A JDBC
     * driver that does not need the type code and type name information may ignore
     * it. To be portable, however, applications should always provide these values
     ...
     * @param sqlType        a value from {@link sandbox.java.sql.Types}
     ...
     * @param sqlType       the JDBC type code defined by
     *                      <code>sandbox.java.sql.Types</code>. If the parameter is
     *                      of JDBC type <code>NUMERIC</code> or
     *                      <code>DECIMAL</code>, the version of
     *                      <code>registerOutParameter</code> that accepts a scale
     *                      value should be used.
     * @exception SQLException                    if parameterName does not
     ...
     * All OUT parameters must be registered before a stored procedure is executed.
     * <p>
     * For a user-named parameter the fully-qualified SQL type name of the parameter
     * should also be given, while a REF parameter requires that the fully-qualified
     ...
     * however, applications should always provide these values for user-named and
     * REF parameters.
     *
     ...
     * @exception SQLException                    if the parameterIndex is not
     *                                            valid; if a database access error
     *                                            occurs, this method is called on a
     *                                            closed
     *                                            <code>CallableStatement</code>, or
     *                                            if the URL being returned is not a
     *                                            valid URL on the Java platform
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     * @see #setURL
     * @since 1.4
     ...
     *                         parameter; if a database access error occurs or this
    ...
    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Date</code>
     * value using the default time zone of the virtual machine that is running the
     ...
     * @since 1.4
     */
    void setDate(String parameterName, sandbox.java.sql.Date x) throws SQLException;

    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Time</code>
     ...
     * @since 1.4
     */
    void setTime(String parameterName, sandbox.java.sql.Time x) throws SQLException;

    /**
     * Sets the designated parameter to the given
     * <code>sandbox.java.sql.Timestamp</code> value. The driver converts this to an
     ...
     * @since 1.4
     */
    void setTimestamp(String parameterName, sandbox.java.sql.Timestamp x) throws SQLException;
     ...
     * @param targetSqlType the SQL type (as defined in sandbox.java.sql.Types) to
     *                      be sent to the database. The scale argument may further
     *                      qualify this type.
     * @param scale         for sandbox.java.sql.Types.DECIMAL or
     *                      sandbox.java.sql.Types.NUMERIC types, this is the number
     *                      of digits after the decimal point. For all other types,
     ...
     * {@link #setObject(String parameterName, Object x, int targetSqlType, int scaleOrLength)},
     ...
     * above.
     * <p>
     * <b>Note:</b> Not all databases allow for a non-typed Null to be sent to the
     * backend. For maximum portability, the <code>setNull</code> or the
     * <code>setObject(String parameterName, Object x, int sqlType)</code> method
     ...
     * @since 1.4
     */
    void setDate(String parameterName, sandbox.java.sql.Date x, Calendar cal) throws SQLException;
     ...
     * @since 1.4
     */
    void setTime(String parameterName, sandbox.java.sql.Time x, Calendar cal) throws SQLException;

    /**
     * Sets the designated parameter to the given
     * <code>sandbox.java.sql.Timestamp</code> value, using the given
     ...
     * then sends to the database. With a a <code>Calendar</code> object, the driver
     * can calculate the timestamp taking into account a custom timezone. If no
     ...
     * @since 1.4
     */
    void setTimestamp(String parameterName, sandbox.java.sql.Timestamp x, Calendar cal) throws SQLException;
     ...
     *
     * @param parameterName the name of the parameter
     * @param sqlType       a value from <code>sandbox.java.sql.Types</code>
     ...
     * @since 1.4
     */
    sandbox.java.sql.Date getDate(String parameterName) throws SQLException;
     ...
     * @since 1.4
     */
    sandbox.java.sql.Time getTime(String parameterName) throws SQLException;

    /**
     * Retrieves the value of a JDBC <code>TIMESTAMP</code> parameter as a
     * <code>sandbox.java.sql.Timestamp</code> object.
     * 
     * @param parameterName the name of the parameter
     * @return the parameter value. If the value is SQL <code>NULL</code>, the
     *         result is <code>null</code>.
     ...
     * @since 1.4
     */
    sandbox.java.sql.Timestamp getTimestamp(String parameterName) throws SQLException;
    ...
    /**
     * Returns an object representing the value of OUT parameter
     * <code>parameterName</code> and uses <code>map</code> for the custom mapping
     * of the parameter value.
     * <p>
     * This method returns a Java object whose type corresponds to the JDBC type
     * that was registered for this parameter using the method
     ...
     * parameter as a {@link sandbox.java.sql.Ref} object in the Java programming
     * language.
     *
     * @param parameterName the name of the parameter
     * @return the parameter value as a <code>Ref</code> object in the Java
     ...
     * @since 1.4
     */
    sandbox.java.sql.Date getDate(String parameterName, Calendar cal) throws SQLException;
     ...
     * @since 1.4
     */
    sandbox.java.sql.Time getTime(String parameterName, Calendar cal) throws SQLException;

    /**
     * Retrieves the value of a JDBC <code>TIMESTAMP</code> parameter as a
     * <code>sandbox.java.sql.Timestamp</code> object, using the given
     * <code>Calendar</code> object to construct the <code>Timestamp</code> object.
     * With a <code>Calendar</code> object, the driver can calculate the timestamp
     * taking into account a custom timezone and locale. If no <code>Calendar</code>
     * object is specified, the driver uses the default timezone and locale.
     ...
     * @since 1.4
     */
    sandbox.java.sql.Timestamp getTimestamp(String parameterName, Calendar cal) throws SQLException;
    ...
    /**
     * Sets the designated parameter to the given
     * <code>sandbox.java.sql.RowId</code> object. The driver converts this to a SQL
     * <code>ROWID</code> when it sends it to the database.
     *
     * @param parameterName the name of the parameter
     * @param x             the parameter value
     * @throws SQLException if parameterName does not correspond to a named
    ...
    /**
     * Sets the designated parameter to a <code>sandbox.java.sql.NClob</code>
     * object. The object implements the <code>sandbox.java.sql.NClob</code>
     * interface. This <code>NClob</code> object maps to a SQL <code>NCLOB</code>.
     * 
     * @param parameterName the name of the parameter to be set
     * @param value         the parameter value
     * @throws SQLException if parameterName does not correspond to a named
     ...
     * @param length        the number of characters in the parameter data.
     * @throws SQLException if parameterName does not correspond to a named
     *                      parameter; if the length specified is less than zero; a
    ...
    /**
     * Sets the designated parameter to an {@code InputStream} object. The
     ...
     * @throws SQLException if parameterName does not correspond to a named
     *                      parameter; if the length specified is less than zero; if
     *                      the number of bytes in the {@code InputStream} does not
     *                      match the specified length; if a database access error
     *                      occurs or this method is called on a closed
     *                      <code>CallableStatement</code>
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     ...
     * @throws SQLException if parameterName does not correspond to a named
     *                      parameter; if the length specified is less than zero; if
     *                      the driver does not support national character sets; if
     *                      the driver can detect that a data conversion error could
     *                      occur; if a database access error occurs or this method
     *                      is called on a closed <code>CallableStatement</code>
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     * @since 1.6
     */
     ...
     * <code>sandbox.java.sql.NClob</code> object in the Java programming language.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, and so on
     ...
     *                                            data conversion error could occur;
     *                                            if a database access error occurs
     *                                            or this method is called on a
     *                                            closed
     *                                            <code>CallableStatement</code>
     ...
     *                                            database access error occurs or
     *                                            this method is called on a closed
     *                                            <code>CallableStatement</code>
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
    ...
    /**
     * Sets the designated parameter to the given
     * <code>sandbox.java.sql.SQLXML</code> object. The driver converts this to an
     ...
     * @throws SQLException if parameterName does not correspond to a named
     *                      parameter; if a database access error occurs; this
     *                      method is called on a closed
     *                      <code>CallableStatement</code> or the
     *                      <code>java.xml.transform.Result</code>,
     *                      <code>Writer</code> or <code>OutputStream</code> has not
     *                      been closed for the <code>SQLXML</code> object
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     *
     * @since 1.6
     ...
     * <code>sandbox.java.sql.SQLXML</code> object in the Java programming language.
     * 
    ...
    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Blob</code>
     * object. The driver converts this to an SQL <code>BLOB</code> value when it
     * sends it to the database.
     *
     * @param parameterName the name of the parameter
    ...
    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Clob</code>
     * object. The driver converts this to an SQL <code>CLOB</code> value when it
     * sends it to the database.
     *
     * @param parameterName the name of the parameter
     ...
     *                                         to a named parameter; if the driver
     *                                         does not support national character
     *                                         sets; if the driver can detect that a
     *                                         data conversion error could occur; if
     ...
     *                      value to.
     * @throws SQLException                    if parameterName does not correspond
     *                                         to a named parameter; if a database
    ...
    /**
     * Sets the designated parameter to an {@code InputStream} object. This method
     * differs from the <code>setBinaryStream (int, InputStream)</code> method
     * because it informs the driver that the parameter value should be sent to the
     * server as a <code>BLOB</code>. When the <code>setBinaryStream</code> method
    ...
    /**
     * Returns an object representing the value of OUT parameter
     * {@code parameterIndex} and will convert from the SQL type of the parameter to
     * the requested Java data type, if the conversion is supported. If the
     * conversion is not supported or null is specified for the type, a
     * <code>SQLException</code> is thrown.
     * <p>
     * At a minimum, an implementation must support the conversions defined in
     * Appendix B, Table B-3 and conversion of appropriate user defined SQL types to
     * a Java type which implements {@code SQLData}, or {@code Struct}. Additional
     ...
     * @throws SQLException                    if conversion is not supported, type
     *                                         is null or another error occurs. The
     *                                         getCause() method of the exception
     *                                         may provide a more detailed
    ...
    /**
     * Returns an object representing the value of OUT parameter
     * {@code parameterName} and will convert from the SQL type of the parameter to
     * the requested Java data type, if the conversion is supported. If the
     * conversion is not supported or null is specified for the type, a
     * <code>SQLException</code> is thrown.
     * <p>
     ...
     * {@code Reader} then the reader must contain the number of characters
     * specified by scaleOrLength. If these conditions are not true the driver will
     * generate a {@code SQLException} when the prepared statement is executed.
     *
     * <p>
     * The given Java object will be converted to the given targetSqlType before
     * being sent to the database.
     ...
     * {@code SQLData.writeSQL} to write it to the SQL data stream. If, on the other
     * hand, the object is of a class implementing {@code Ref}, {@code Blob},
     * {@code Clob}, {@code NClob}, {@code Struct}, {@code java.net.URL}, or
     * {@code Array}, the driver should pass it to the database as a value of the
     ...
     * @param parameterName the name of the parameter
     * @param x             the object containing the input parameter value
     * @param targetSqlType the SQL type to be sent to the database. The scale
     *                      argument may further qualify this type.
     * @param scaleOrLength for {@code sandbox.java.sql.JDBCType.DECIMAL} or
     *                      {@code sandbox.java.sql.JDBCType.NUMERIC types}, this is
     *                      the number of digits after the decimal point. For Java
     *                      Object types {@code InputStream} and {@code Reader},
     ...
     *                                            if a database access error occurs
     *                                            or this method is called on a
     *                                            closed {@code CallableStatement}
     *                                            or if the Java Object specified by
     *                                            x is an InputStream or Reader
     *                                            object and the value of the scale
    ...
    default void setObject(String parameterName, Object x, SQLType targetSqlType,
        ...
        throw new SQLFeatureNotSupportedException(String.toDJVM("setObject not implemented"));
    }
     ...
     *
     * This method is similar to
     * {@link #setObject(String parameterName, Object x, SQLType targetSqlType, int scaleOrLength)},
     * except that it assumes a scale of zero.
     * <P>
     * The default implementation will throw {@code SQLFeatureNotSupportedException}
     *
    ...
    /**
     * Registers the OUT parameter in ordinal position {@code parameterIndex} to the
     * JDBC type {@code sqlType}. All OUT parameters must be registered before a
     * stored procedure is executed.
     * <p>
     * The JDBC type specified by {@code sqlType} for an OUT parameter determines
     * the Java type that must be used in the {@code get} method to read the value
     * of that parameter.
     * <p>
     * If the JDBC type expected to be returned to this output parameter is specific
     * to this particular database, {@code sqlType} may be {@code JDBCType.OTHER} or
     * a {@code SQLType} that is supported by the JDBC driver. The method
     ...
     *                       register the OUT Parameter. If the parameter is of JDBC
     *                       type {@code JDBCType.NUMERIC} or
     *                       {@code JDBCType.DECIMAL}, the version of
    ...
    default void registerOutParameter(int parameterIndex, SQLType sqlType) throws SQLException {
        throw new SQLFeatureNotSupportedException(String.toDJVM("registerOutParameter not implemented"));
    }

    /**
     * Registers the parameter in ordinal position {@code parameterIndex} to be of
     * JDBC type {@code sqlType}. All OUT parameters must be registered before a
     * stored procedure is executed.
     * <p>
     * The JDBC type specified by {@code sqlType} for an OUT parameter determines
     ...
     * of that parameter.
     * <p>
     * This version of {@code  registerOutParameter} should be used when the
     * parameter is of JDBC type {@code JDBCType.NUMERIC} or
    ...
    /**
     * Registers the designated output parameter. This version of the method
     * {@code  registerOutParameter} should be used for a user-defined or
     * {@code REF} output parameter. Examples of user-defined types include:
     * {@code STRUCT}, {@code DISTINCT}, {@code JAVA_OBJECT}, and named array types.
     * <p>
     * All OUT parameters must be registered before a stored procedure is executed.
     * <p>
     * For a user-defined parameter, the fully-qualified SQL type name of the
     * parameter should also be given, while a {@code REF} parameter requires that
     * the fully-qualified type name of the referenced type be given. A JDBC driver
     * that does not need the type code and type name information may ignore it. To
     * be portable, however, applications should always provide these values for
     * user-defined and {@code REF} parameters.
     *
     * Although it is intended for user-defined and {@code REF} parameters, this
     * method may be used to register a parameter of any JDBC type. If the parameter
     * does not have a user-defined or {@code REF} type, the <i>typeName</i>
    ...
    /**
     * Registers the OUT parameter named <code>parameterName</code> to the JDBC type
     * {@code sqlType}. All OUT parameters must be registered before a stored
     * procedure is executed.
     * <p>
     * The JDBC type specified by {@code sqlType} for an OUT parameter determines
     * the Java type that must be used in the {@code get} method to read the value
     ...
     * <p>
     * If the JDBC type expected to be returned to this output parameter is specific
     * to this particular database, {@code sqlType} should be {@code JDBCType.OTHER}
     * or a {@code SQLType} that is supported by the JDBC driver.. The method
     * {@link #getObject} retrieves the value.
     * <P>
     * The default implementation will throw {@code SQLFeatureNotSupportedException}
     *
     ...
     *                                            closed {@code CallableStatement}
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support the specified sqlType or
    ...
    /**
     * Registers the designated output parameter. This version of the method
     * {@code  registerOutParameter} should be used for a user-named or REF output
     ...
     * <P>
     * <B>Note:</B> When reading the value of an out parameter, you must use the
     * {@code getXXX} method whose Java type XXX corresponds to the parameter's
     * registered SQL type.
     * <P>
     * The default implementation will throw {@code SQLFeatureNotSupportedException}
     *
