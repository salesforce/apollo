...
public interface CallableStatement extends PreparedStatement {
     ...
     * should be <code>sandbox.java.sql.Types.OTHER</code>.  The method
     * {@link #getObject} retrieves the value.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,
     *        and so on
     * @param sqlType the JDBC type code defined by <code>sandbox.java.sql.Types</code>.
     ...
     * @param parameterIndex the first parameter is 1, the second is 2,
     * and so on
     * @param sqlType the SQL type code defined by <code>sandbox.java.sql.Types</code>.
     ...
     * @see #setTimestamp
     */
    sandbox.java.sql.Timestamp getTimestamp(int parameterIndex)
        throws SQLException;
     ...
     * type as <code>sandbox.java.sql.Types.OTHER</code>, this method can be used
     ...
     * JDBC type as <code>sandbox.java.sql.Types.OTHER</code>, this method can
     ...
     * parameter as a {@link sandbox.java.sql.Ref} object in the Java programming language.
     * @param parameterIndex the first parameter is 1, the second is 2,
     * and so on
    ...
    /**
     * Retrieves the value of the designated JDBC <code>DATE</code> parameter as a
     * <code>sandbox.java.sql.Date</code> object, using
     ...
     * @since 1.2
     */
    sandbox.java.sql.Date getDate(int parameterIndex, Calendar cal)
        throws SQLException;

    /**
     * Retrieves the value of the designated JDBC <code>TIME</code> parameter as a
     * <code>sandbox.java.sql.Time</code> object, using
     * the given <code>Calendar</code> object
     ...
     * @since 1.2
     */
    sandbox.java.sql.Time getTime(int parameterIndex, Calendar cal)
        throws SQLException;

    /**
     * Retrieves the value of the designated JDBC <code>TIMESTAMP</code> parameter as a
     * <code>sandbox.java.sql.Timestamp</code> object, using
     ...
     * @since 1.2
     */
    sandbox.java.sql.Timestamp getTimestamp(int parameterIndex, Calendar cal)
        throws SQLException;
  ...
  //--------------------------JDBC 3.0-----------------------------
     ...
     *
     * @param parameterName the name of the parameter
     * @param sqlType SQL type code defined by <code>sandbox.java.sql.Types</code>.
     * @param scale the desired number of digits to the right of the
     * decimal point.  It must be greater than or equal to zero.
     * @exception SQLException if parameterName does not correspond to a named
     * parameter; if a database access error occurs or
     ...
     *
     * @param parameterName the name of the parameter
     * @param sqlType the SQL type code defined in <code>sandbox.java.sql.Types</code>
     * @exception SQLException if parameterName does not correspond to a named
     * parameter; if a database access error occurs or
     * this method is called on a closed <code>CallableStatement</code>
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not support
    ...
    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Date</code> value
     ...
     * @since 1.4
     */
    void setDate(String parameterName, sandbox.java.sql.Date x)
        throws SQLException;

    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Time</code> value.
     * The driver converts this
     ...
     * @since 1.4
     */
    void setTime(String parameterName, sandbox.java.sql.Time x)
        throws SQLException;

    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Timestamp</code> value.
     * The driver
     ...
     * @since 1.4
     */
    void setTimestamp(String parameterName, sandbox.java.sql.Timestamp x)
        throws SQLException;
     ...
     * @param targetSqlType the SQL type (as defined in sandbox.java.sql.Types) to be
     * sent to the database. The scale argument may further qualify this type.
     * @param scale for sandbox.java.sql.Types.DECIMAL or sandbox.java.sql.Types.NUMERIC types,
     ...
     * @since 1.4
     */
    void setDate(String parameterName, sandbox.java.sql.Date x, Calendar cal)
        throws SQLException;
     ...
     * @since 1.4
     */
    void setTime(String parameterName, sandbox.java.sql.Time x, Calendar cal)
        throws SQLException;
     ...
     * @since 1.4
     */
    void setTimestamp(String parameterName, sandbox.java.sql.Timestamp x, Calendar cal)
        throws SQLException;
     ...
     * @since 1.4
     */
    sandbox.java.sql.Date getDate(String parameterName, Calendar cal)
        throws SQLException;
     ...
     * @since 1.4
     */
    sandbox.java.sql.Time getTime(String parameterName, Calendar cal)
        throws SQLException;
     ...
     * @since 1.4
     */
    sandbox.java.sql.Timestamp getTimestamp(String parameterName, Calendar cal)
        throws SQLException;
    ...
    RowId getRowId(String parameterName) throws SQLException;
     ...
     /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.RowId</code> object. The
    ...
    void setNCharacterStream(String parameterName, Reader value, long length)
     ...
     /**
     * Sets the designated parameter to a <code>sandbox.java.sql.NClob</code> object. The object
     * implements the <code>sandbox.java.sql.NClob</code> interface. This <code>NClob</code>
    ...
    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.SQLXML</code> object. The driver converts this to an
   ...
   *  <code>Writer</code> or <code>OutputStream</code> has not been closed for the <code>SQLXML</code> object
    ...
    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Blob</code> object.
    ...
    /**
     * Sets the designated parameter to the given <code>sandbox.java.sql.Clob</code> object.
  ...
  /**
     ...
     * sent to the database. The scale argument may further qualify this type.
     * @param scaleOrLength for {@code sandbox.java.sql.JDBCType.DECIMAL}
     *          or {@code sandbox.java.sql.JDBCType.NUMERIC types},
