...
public interface Connection  extends Wrapper, AutoCloseable {
     ...
     *
     * @see sandbox.java.sql.Connection#setClientInfo(String, String) setClientInfo(String, String)
     * @since 1.6
     *
     * @throws SQLClientInfoException if the database server returns an error while
...
/**
  ...
  * sandbox.java.sql.Types for the given class of <code>Object</code>. The default
