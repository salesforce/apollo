...
/**
 * An exception thrown as a <code>DataTruncation</code> exception (on writes) or
 * reported as a <code>DataTruncation</code> warning (on reads) when a data
 * values is unexpectedly truncated for reasons other than its having exceeded
 * <code>MaxFieldSize</code>.
 *
 * <P>
 * The SQLstate for a <code>DataTruncation</code> during read is
 * <code>01004</code>.
 * <P>
 * The SQLstate for a <code>DataTruncation</code> during write is
 * <code>22001</code>.
 *
 * @since 1.1
 */
...
public class DataTruncation extends SQLWarning {
    ...
    /**
     * Creates a <code>DataTruncation</code> object with the SQLState initialized to
     * 01004 when <code>read</code> is set to <code>true</code> and 22001 when
     * <code>read</code> is set to <code>false</code>, the reason set to "Data
     * truncation", the vendor code set to 0, and the other fields set to the given
     * values. The <code>cause</code> is not initialized, and may subsequently be
    ...
    public DataTruncation(int index, boolean parameter, boolean read, int dataSize, int transferSize) {
        super(String.toDJVM("Data truncation"), read == true ? String.toDJVM("01004") : String.toDJVM("22001"));
        this.index = index;
     ...
     *                     <code>DataTruncation</code> (which is saved for later
     *                     retrieval by the <code>getCause()</code> method); may be
    ...
    public DataTruncation(int index, boolean parameter, boolean read, int dataSize, int transferSize, Throwable cause) {
        super(String.toDJVM("Data truncation"), read == true ? String.toDJVM("01004") : String.toDJVM("22001"), cause);
        this.index = index;
        this.parameter = parameter;
        this.read = read;
        this.dataSize = dataSize;
     ...
     * <code>parameter</code> and <code>read</code> fields should be ignored.
     *
     ...
     * number may be approximate if data conversions were being performed. The value
     * may be <code>-1</code> if the size is unknown.
     *
