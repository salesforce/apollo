...
public interface Driver {
     ...
     * "password" properties should be included in the {@code Properties} object.
     * <p>
     ...
     * the sub-protocol specified in the URL and <code>false</code> if they do not.
     *
     ...
     * only report <code>true</code> here if it passes the JDBC compliance tests;
     * otherwise it is required to return <code>false</code>.
     * <P>
     ...
     * interested in using the JDBC API and framework for lightweight databases that
     * do not support full database functionality, or for special databases such as
     * document information retrieval where a SQL implementation may not be
     * feasible.
     * 
