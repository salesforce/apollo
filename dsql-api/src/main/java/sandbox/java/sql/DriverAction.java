 ...
 * {@linkplain DriverManager#registerDriver(sandbox.java.sql.Driver, sandbox.java.sql.DriverAction) } in order
...
public interface DriverAction {
     ...
     * on its behavior.
     * @see DriverManager#registerDriver(sandbox.java.sql.Driver, sandbox.java.sql.DriverAction)
