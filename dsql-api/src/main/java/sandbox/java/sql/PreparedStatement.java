 ...
 *
 * <P>
 * <B>Note:</B> The setter methods (<code>setShort</code>,
 * <code>setString</code>, and so on) for setting IN parameter values must
...
public interface PreparedStatement extends Statement {
     ...
     *                         called on a closed <code>PreparedStatement</code> or
     *                         the SQL statement does not return a
     ...
     * <code>INSERT</code>, <code>UPDATE</code> or <code>DELETE</code>; or an SQL
     ...
     * @exception SQLException if a database access error occurs; this method is
     *                         called on a closed <code>PreparedStatement</code> or
     *                         the SQL statement returns a <code>ResultSet</code>
     *                         object
     * @throws SQLTimeoutException when the driver has determined that the timeout
     *                             value that was specified by the
     *                             {@code setQueryTimeout} method has been exceeded
     ...
     * @exception SQLException                    if parameterIndex does not
     *                                            correspond to a parameter marker
     *                                            in the SQL statement; if a
     ...
     * driver converts this to an SQL <code>REAL</code> value when it sends it to
     * the database.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, ...
     * @param x              the parameter value
     ...
     *                         <code>PreparedStatement</code>
     */
    void setDate(int parameterIndex, sandbox.java.sql.Date x) throws SQLException;
     ...
     *                         <code>PreparedStatement</code>
     */
    void setTime(int parameterIndex, sandbox.java.sql.Time x) throws SQLException;
     ...
     *                         <code>PreparedStatement</code>
     */
    void setTimestamp(int parameterIndex, sandbox.java.sql.Timestamp x) throws SQLException;
     ...
     *
     * @param parameterIndex the first parameter is 1, the second is 2, ...
     * @param x              a <code>java.io.InputStream</code> object that contains
     *                       the Unicode parameter value
     * @param length         the number of bytes in the stream
     * @exception SQLException                    if parameterIndex does not
     *                                            correspond to a parameter marker
     *                                            in the SQL statement; if a
     ...
     * <code>NClob</code>, <code>Struct</code>, <code>java.net.URL</code>,
     * <code>RowId</code>, <code>SQLXML</code> or <code>Array</code>, the driver
     ...
     * <p>
     * <b>Note:</b> This method throws an exception if there is an ambiguity, for
     * example, if the object is of a class implementing more than one of the
     ...
     *                         <code>PreparedStatement</code> or the type of the
     ...
     * @exception SQLException if a database access error occurs; this method is
     *                         called on a closed <code>PreparedStatement</code> or
     *                         an argument is supplied to this method
     * @throws SQLTimeoutException when the driver has determined that the timeout
     *                             value that was specified by the
     *                             {@code setQueryTimeout} method has been exceeded
     *                             and has at least attempted to cancel the
    ...
    /**
     * Sets the designated parameter to the given
     * <code>sandbox.java.sql.Array</code> object. The driver converts this to an
     * SQL <code>ARRAY</code> value when it sends it to the database.
     *
     * @param parameterIndex the first parameter is 1, the second is 2, ...
     ...
     * @since 1.2
     */
    void setDate(int parameterIndex, sandbox.java.sql.Date x, Calendar cal) throws SQLException;
     ...
     * @since 1.2
     */
    void setTime(int parameterIndex, sandbox.java.sql.Time x, Calendar cal) throws SQLException;
     ...
     * then sends to the database. With a <code>Calendar</code> object, the driver
     ...
     * @since 1.2
     */
    void setTimestamp(int parameterIndex, sandbox.java.sql.Timestamp x, Calendar cal) throws SQLException;
     ...
     *         about the number, types and properties for each parameter marker of
     *         this <code>PreparedStatement</code> object
     * @exception SQLException if a database access error occurs or this method is
     *                         called on a closed <code>PreparedStatement</code>
     ...
     *                                         statement; if a database access error
     ...
     * object. The driver converts this to a SQL <code>NCLOB</code> value when it
     * sends it to the database.
     * 
     * @param parameterIndex of the first parameter is 1, the second is 2, ...
     * @param value          the parameter value
     ...
     *                                         closed <code>PreparedStatement</code>
     *                                         or if the length specified is less
     *                                         than zero.
     *
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method
     ...
     * {@code Inputstream} must contain the number of characters specified by length
     ...
     *                                         zero or if the number of bytes in the
     *                                         {@code InputStream} does not match
     ...
     * driver will generate a <code>SQLException</code> when the prepared statement
     * is executed.
     *
     * <p>
     ...
     *                       qualify this type.
     * @param scaleOrLength  for <code>sandbox.java.sql.Types.DECIMAL</code> or
     *                       <code>sandbox.java.sql.Types.NUMERIC types</code>, this
     *                       is the number of digits after the decimal point. For
     *                       Java Object types <code>InputStream</code> and
     ...
     *                                            correspond to a parameter marker
     *                                            in the SQL statement; if a
     *                                            database access error occurs; this
     *                                            method is called on a closed
     *                                            <code>PreparedStatement</code> or
     *                                            if the Java Object specified by x
     *                                            is an InputStream or Reader object
     ...
     *                                         occurs; this method is called on a
     *                                         closed <code>PreparedStatement</code>
     *                                         or if parameterIndex does not
     *                                         correspond to a parameter marker in
     *                                         the SQL statement,
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method
     *
     ...
     *                       {@code sandbox.java.sql.JDBCType.NUMERIC types}, this
     *                       is the number of digits after the decimal point. For
     *                       Java Object types {@code InputStream} and
     *                       {@code Reader}, this is the length of the data in the
     *                       stream or reader. For all other types, this value will
     *                       be ignored.
     * @exception SQLException                    if parameterIndex does not
     *                                            correspond to a parameter marker
     *                                            in the SQL statement; if a
     *                                            database access error occurs or
     *                                            this method is called on a closed
     *                                            {@code PreparedStatement} or if
     *                                            the Java Object specified by x is
     *                                            an InputStream or Reader object
     *                                            and the value of the scale
     *                                            parameter is less than zero
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support the specified
