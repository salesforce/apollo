 ...
 * to the intended columns, which can be assured with the SQL <i>AS</i> clause.
 * <P>
 * A set of updater methods were added to this interface in the JDBC 2.0 API
 * (Java 2 SDK, Standard Edition, version 1.2). The comments regarding
 ...
 * are provided by the <code>ResultSetMetaData</code> object returned by the
...
public interface ResultSet extends Wrapper, AutoCloseable {
     ...
     * 0, a value of <code>false</code> is returned. If the designated column has a
     * datatype of CHAR or VARCHAR and contains a "1" or has a datatype of BIT,
     * TINYINT, SMALLINT, INTEGER or BIGINT and contains a 1, a value of
    ...
    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> object as a <code>sandbox.java.sql.BigDecimal</code>
    ...
    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> object as a <code>sandbox.java.sql.Date</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is 1, the second is 2, ...
     * @return the column value; if the value is SQL <code>NULL</code>, the value
     ...
     *                         result set
     */
    sandbox.java.sql.Date getDate(int columnIndex) throws SQLException;

    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> object as a <code>sandbox.java.sql.Time</code> object
     * in the Java programming language.
     *
     * @param columnIndex the first column is 1, the second is 2, ...
     * @return the column value; if the value is SQL <code>NULL</code>, the value
     ...
     *                         result set
     */
    sandbox.java.sql.Time getTime(int columnIndex) throws SQLException;

    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> object as a <code>sandbox.java.sql.Timestamp</code>
     ...
     *                         result set
     */
    sandbox.java.sql.Timestamp getTimestamp(int columnIndex) throws SQLException;
    ...
    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> object as as a stream of two-byte 3 characters. The
     ...
     *                         result set
     */
    sandbox.java.sql.Date getDate(String columnLabel) throws SQLException;
     ...
     *                         result set
     */
    sandbox.java.sql.Time getTime(String columnLabel) throws SQLException;
     ...
     *                         result set
     */
    sandbox.java.sql.Timestamp getTimestamp(String columnLabel) throws SQLException;
     ...
     * <code>SQLFeatureNotSupportedException</code>, then when a column contains a
     * structured or distinct value, the behavior of this method is as if it were a
     * call to: <code>getObject(columnIndex,
     * this.getStatement().getConnection().getTypeMap())</code>.
     *
     * If <code>Connection.getTypeMap</code> does throw a
     * <code>SQLFeatureNotSupportedException</code>, then structured values are not
     * supported, and distinct values are mapped to the default Java class as
     * determined by the underlying SQL type of the DISTINCT type.
     *
     * @param columnIndex the first column is 1, the second is 2, ...
     ...
     * @exception SQLException if the <code>ResultSet</code> object does not contain
     *                         a column labeled <code>columnLabel</code>, a database
     ...
     * <code>ResultSet</code> object. <strong>Note:</strong> Calling the method
     * <code>isLast</code> may be expensive because the JDBC driver might need to
     * fetch ahead one row in order to determine whether the current row is the last
     ...
     *                                            result set or the result set type
     ...
     * forward direction; first-to-last. This constant is used by the method
     * <code>setFetchDirection</code> as a hint to the driver, which the driver may
     * ignore.
     * 
     * @since 1.2
     */
    ...
    /**
     * The constant indicating that the rows in a result set will be processed in a
     * reverse direction; last-to-first. This constant is used by the method
     * <code>setFetchDirection</code> as a hint to the driver, which the driver may
     * ignore.
     * 
     * @since 1.2
     ...
     * processed is unknown. This constant is used by the method
     * <code>setFetchDirection</code> as a hint to the driver, which the driver may
     * ignore.
     */
     ...
     *                         called on a closed result set or the result set type
     ...
     * @exception SQLException if a database access error occurs; this method is
     *                         called on a closed result set or the condition
    ...
    /**
     * The constant indicating the type for a <code>ResultSet</code> object that is
     * scrollable but generally not sensitive to changes to the data that underlies
    ...
    /**
     * The constant indicating the type for a <code>ResultSet</code> object that is
     * scrollable and generally sensitive to changes to the data that underlies the
     * <code>ResultSet</code>.
     * 
     * @since 1.2
     */
     ...
     * <p>
     * <strong>Note:</strong> Support for the <code>rowUpdated</code> method is
     ...
     * visible inserts.
     * <p>
     * <strong>Note:</strong> Support for the <code>rowInserted</code> method is
     * optional with a result set concurrency of <code>CONCUR_READ_ONLY</code>
     * 
    ...
    /**
     * Updates the designated column with a <code>sandbox.java.sql.Date</code>
     ...
     * @since 1.2
     */
    void updateDate(int columnIndex, sandbox.java.sql.Date x) throws SQLException;

    /**
     * Updates the designated column with a <code>sandbox.java.sql.Time</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     * @since 1.2
     */
    void updateTime(int columnIndex, sandbox.java.sql.Time x) throws SQLException;

    /**
     * Updates the designated column with a <code>sandbox.java.sql.Timestamp</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     * @since 1.2
     */
    void updateTimestamp(int columnIndex, sandbox.java.sql.Timestamp x) throws SQLException;
     ...
     * called to update the database.
     * <p>
     * If the second argument is an <code>InputStream</code> then the stream must
     * contain the number of bytes specified by scaleOrLength. If the second
     * argument is a <code>Reader</code> then the reader must contain the number of
     * characters specified by scaleOrLength. If these conditions are not true the
     * driver will generate a <code>SQLException</code> when the statement is
     * executed.
     *
     * @param columnIndex   the first column is 1, the second is 2, ...
     * @param x             the new column value
     ...
     *                      For Java Object types <code>InputStream</code> and
     *                      <code>Reader</code>, this is the length of the data in
     *                      the stream or reader. For all other types, this value
     *                      will be ignored.
     * @exception SQLException                    if the columnIndex is not valid;
     *                                            if a database access error occurs;
     *                                            the result set concurrency is
    ...
    /**
     * Updates the designated column with a <code>sandbox.java.sql.BigDecimal</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     * @since 1.2
     */
    void updateDate(String columnLabel, sandbox.java.sql.Date x) throws SQLException;
     ...
     * @since 1.2
     */
    void updateTime(String columnLabel, sandbox.java.sql.Time x) throws SQLException;
     ...
     * @since 1.2
     */
    void updateTimestamp(String columnLabel, sandbox.java.sql.Timestamp x) throws SQLException;
     ...
     *                                            this method is called on a closed
     *                                            result set, if this method is
     *                                            called when the cursor is not on
     *                                            the insert row, or if not all of
     *                                            non-nullable columns in the insert
     *                                            row have been given a non-null
     *                                            value
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     * @since 1.2
     ...
     *                                            <code>CONCUR_READ_ONLY</code>;
     *                                            this method is called on a closed
     *                                            result set or if this method is
     *                                            called when the cursor is on the
     *                                            insert row
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     * @since 1.2
     ...
     * @exception SQLException                    if a database access error occurs;
     *                                            this method is called on a closed
     *                                            result set; the result set type is
     *                                            <code>TYPE_FORWARD_ONLY</code> or
     ...
     * way, such as by a <code>DatabaseMetaData</code> method, this method may
     * return <code>null</code>.
     *
     * @return the <code>Statement</code> object that produced this
     ...
     * @return the column value as a <code>sandbox.java.sql.Date</code> object; if
     ...
     * @since 1.2
     */
    sandbox.java.sql.Date getDate(int columnIndex, Calendar cal) throws SQLException;
     ...
     * @since 1.2
     */
    sandbox.java.sql.Date getDate(String columnLabel, Calendar cal) throws SQLException;
     ...
     * @return the column value as a <code>sandbox.java.sql.Time</code> object; if
     *         the value is SQL <code>NULL</code>, the value returned is
     *         <code>null</code> in the Java programming language
     * @exception SQLException if the columnIndex is not valid; if a database access
     *                         error occurs or this method is called on a closed
     ...
     * @since 1.2
     */
    sandbox.java.sql.Time getTime(int columnIndex, Calendar cal) throws SQLException;
     ...
     * @since 1.2
     */
    sandbox.java.sql.Time getTime(String columnLabel, Calendar cal) throws SQLException;

    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> object as a <code>sandbox.java.sql.Timestamp</code>
     * object in the Java programming language. This method uses the given calendar
     * to construct an appropriate millisecond value for the timestamp if the
     * underlying database does not store timezone information.
     *
     * @param columnIndex the first column is 1, the second is 2, ...
     * @param cal         the <code>java.util.Calendar</code> object to use in
     *                    constructing the timestamp
     * @return the column value as a <code>sandbox.java.sql.Timestamp</code> object;
     *         if the value is SQL <code>NULL</code>, the value returned is
     *         <code>null</code> in the Java programming language
     * @exception SQLException if the columnIndex is not valid; if a database access
     *                         error occurs or this method is called on a closed
     ...
     * @since 1.2
     */
    sandbox.java.sql.Timestamp getTimestamp(int columnIndex, Calendar cal) throws SQLException;
     ...
     * @since 1.2
     */
    sandbox.java.sql.Timestamp getTimestamp(String columnLabel, Calendar cal) throws SQLException;
     ...
     *         is SQL <code>NULL</code>, the value returned is <code>null</code> in
     *         the Java programming language
     * @exception SQLException                    if the columnIndex is not valid;
     *                                            if a database access error occurs;
     *                                            this method is called on a closed
     *                                            result set or if a URL is
     *                                            malformed
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     * @since 1.4
    ...
    /**
     * Updates the designated column with a <code>sandbox.java.sql.Ref</code> value.
     * The updater methods are used to update column values in the current row or
     * the insert row. The updater methods do not update the underlying database;
     * instead the <code>updateRow</code> or <code>insertRow</code> methods are
     * called to update the database.
     ...
     * @since 1.4
     */
    void updateRef(int columnIndex, sandbox.java.sql.Ref x) throws SQLException;
     ...
     * @since 1.4
     */
    void updateRef(String columnLabel, sandbox.java.sql.Ref x) throws SQLException;

    /**
     * Updates the designated column with a <code>sandbox.java.sql.Blob</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     * @since 1.4
     */
    void updateBlob(int columnIndex, sandbox.java.sql.Blob x) throws SQLException;
     ...
     * @since 1.4
     */
    void updateBlob(String columnLabel, sandbox.java.sql.Blob x) throws SQLException;

    /**
     * Updates the designated column with a <code>sandbox.java.sql.Clob</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     * @since 1.4
     */
    void updateClob(int columnIndex, sandbox.java.sql.Clob x) throws SQLException;
     ...
     * @since 1.4
     */
    void updateClob(String columnLabel, sandbox.java.sql.Clob x) throws SQLException;

    /**
     * Updates the designated column with a <code>sandbox.java.sql.Array</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     * @since 1.4
     */
    void updateArray(int columnIndex, sandbox.java.sql.Array x) throws SQLException;
     ...
     * @since 1.4
     */
    void updateArray(String columnLabel, sandbox.java.sql.Array x) throws SQLException;

    // ------------------------- JDBC 4.0 -----------------------------------

    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> object as a <code>sandbox.java.sql.RowId</code> object
     * in the Java programming language.
     *
     ...
     *                      detect that a data conversion error could occur; this
     *                      method is called on a closed result set; the result set
     *                      concurrency is <code>CONCUR_READ_ONLY</code> or if a
    ...
    /**
     * Updates the designated column with a <code>sandbox.java.sql.NClob</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     *                      support national character sets; if the driver can
     *                      detect that a data conversion error could occur; this
     *                      method is called on a closed result set; if a database
     *                      access error occurs or the result set concurrency is
     *                      <code>CONCUR_READ_ONLY</code>
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     * @since 1.6
     ...
     *                                            conversion error could occur; this
     *                                            method is called on a closed
     *                                            result set or if a database access
     *                                            error occurs
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method
     * @since 1.6
    ...
    /**
     * Retrieves the value of the designated column in the current row of this
     * <code>ResultSet</code> as a <code>sandbox.java.sql.SQLXML</code> object in
     * the Java programming language.
     * 
     * @param columnIndex the first column is 1, the second is 2, ...
    ...
    /**
     * Updates the designated column with a <code>sandbox.java.sql.SQLXML</code>
     * value. The updater methods are used to update column values in the current
     * row or the insert row. The updater methods do not update the underlying
     * database; instead the <code>updateRow</code> or <code>insertRow</code>
     * methods are called to update the database.
     ...
     *                      been closed for the <code>SQLXML</code> object; if there
     *                      is an error processing the XML value or the result set
     *                      concurrency is <code>CONCUR_READ_ONLY</code>. The
     *                      <code>getCause</code> method of the exception may
     *                      provide a more detailed exception, for example, if the
     ...
     * column to the requested Java data type, if the conversion is supported. If
     * the conversion is not supported or null is specified for the type, a
     ...
     * The updater methods are used to update column values in the current row or
     * the insert row. The updater methods do not update the underlying database;
     * instead the {@code updateRow} or {@code insertRow} methods are called to
     * update the database.
     * <p>
     ...
     * generate a {@code SQLException} when the statement is executed.
     * <p>
     ...
     * @param scaleOrLength for an object of {@code java.math.BigDecimal} , this is
     ...
     *                                            if a database access error occurs;
     *                                            the result set concurrency is
     *                                            {@code CONCUR_READ_ONLY} or this
     *                                            method is called on a closed
     *                                            result set
     * @exception SQLFeatureNotSupportedException if the JDBC driver does not
     *                                            support this method; if the JDBC
     *                                            driver does not support the
     *                                            specified targetSqlType
     * @see JDBCType
     * @see SQLType
     * @since 1.8
     */
    default void updateObject(int columnIndex, Object x, SQLType targetSqlType, int scaleOrLength) throws SQLException {
        throw new SQLFeatureNotSupportedException(String.toDJVM("updateObject not implemented"));
    }
     ...
     * <p>
     * If the second argument is an {@code InputStream} then the stream must contain
     * number of bytes specified by scaleOrLength. If the second argument is a
     * {@code Reader} then the reader must contain the number of characters
     * specified by scaleOrLength. If these conditions are not true the driver will
     * generate a {@code SQLException} when the statement is executed.
     * <p>
