...
public class SQLException extends sandbox.java.lang.Exception implements Iterable<Throwable> {
    ...
    public SQLException(String reason, String SQLState, int vendorCode) {
        ...
        if (!(this instanceof SQLWarning)) {
            if (DriverManager.getLogWriter() != null) {
                DriverManager.println(String.toDJVM("SQLState(" + SQLState + ") vendor code(" + vendorCode + ")"));
    ...
    public SQLException(String reason, String SQLState) {
        ...
        if (!(this instanceof SQLWarning)) {
            if (DriverManager.getLogWriter() != null) {
                printStackTrace(DriverManager.getLogWriter());
                DriverManager.println(String.toDJVM("SQLException: SQLState(" + SQLState + ")"));
            }
        }
    }
    ...
    /**
     * Constructs a <code>SQLException</code> object with a given
     * <code>reason</code>, <code>SQLState</code> and <code>cause</code>. The vendor
     * code is initialized to 0.
     *
     * @param reason   a description of the exception.
     * @param sqlState an XOPEN or SQL:2003 code identifying the exception
    ...
    public SQLException(String reason, String sqlState, Throwable cause) {
        ...
        if (!(this instanceof SQLWarning)) {
            if (DriverManager.getLogWriter() != null) {
                printStackTrace(DriverManager.getLogWriter());
                DriverManager.println(String.toDJVM("SQLState(" + SQLState + ")"));
            }
        }
    }
    ...
    /**
     * Retrieves the exception chained to this <code>SQLException</code> object by
    ...
    private static final AtomicReferenceFieldUpdater<SQLException, SQLException> nextUpdater = AtomicReferenceFieldUpdater.newUpdater(SQLException.class,
                                                                                                                                      SQLException.class,
                                                                                                                                      "next");
