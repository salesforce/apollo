 ...
 */
 ...
 public interface SQLOutput {
  ...
  /**
   * Writes the next attribute to the stream as a sandbox.java.sql.Date object.
   * Writes the next attribute to the stream as a <code>sandbox.java.sql.Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
   * @exception SQLException if a database access error occurs
   ...
   * @since 1.2
   */
  void writeDate(sandbox.java.sql.Date x) throws SQLException;

  /**
   * Writes the next attribute to the stream as a sandbox.java.sql.Time object.
   * Writes the next attribute to the stream as a <code>sandbox.java.sql.Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
   ...
   * @since 1.2
   */
  void writeTime(sandbox.java.sql.Time x) throws SQLException;

  /**
   * Writes the next attribute to the stream as a sandbox.java.sql.Timestamp object.
   * Writes the next attribute to the stream as a <code>sandbox.java.sql.Date</code> object
   * in the Java programming language.
   *
   * @param x the value to pass to the database
   ...
   * @since 1.2
   */
  void writeTimestamp(sandbox.java.sql.Timestamp x) throws SQLException;
