...
public interface Statement extends Wrapper, AutoCloseable {
     ...
     * <code>NVARCHAR</code>, <code>LONGNVARCHAR</code> and <code>LONGVARCHAR</code>
     ...
     * @exception SQLException if a database access error occurs, this method is
     *                         called on a closed <code>Statement</code> or the
     ...
     * behavior. A value of true (the default) enables escape Processing for all
     * {@code Statement} objects. A value of false disables escape processing for
     * all {@code Statement} objects. The {@code setEscapeProcessing} method may be
     * used to specify the escape processing behavior for an individual
     ...
     * <code>PreparedStatement</code> or <code>CallableStatement</code>.
     * 
     * @param sql typically this is a SQL <code>INSERT</code> or <code>UPDATE</code>
     *            statement
     * @exception SQLException if a database access error occurs, this method is
     *                         called on a closed <code>Statement</code>, the driver
     *                         does not support batch updates, the method is called
     *                         on a <code>PreparedStatement</code> or
     *                         <code>CallableStatement</code>
     * @see #executeBatch
     ...
     * </OL>
     * <P>
     * The possible implementations and return values have been modified in the Java
     * 2 SDK, Standard Edition, version 1.3 to accommodate the option of continuing
     * to process commands in a batch update after a
     ...
     *                         <code>SQLException</code>) if one of the commands
     *                         sent to the database fails to execute properly or
    ...
    /**
     * The constant indicating that the current <code>ResultSet</code> object should
     * be closed when calling <code>getMoreResults</code>.
     *
     * @since 1.4
     */
    ...
    /**
     * The constant indicating that the current <code>ResultSet</code> object should
     * not be closed when calling <code>getMoreResults</code>.
     *
     * @since 1.4
     */
     ...
     *                                            argument supplied is not one of
     *                                            the following:
     *                                            <code>Statement.CLOSE_CURRENT_RESULT</code>,
     *                                            <code>Statement.KEEP_CURRENT_RESULT</code>
     *                                            or
     *                                            <code>Statement.CLOSE_ALL_RESULTS</code>
     * @exception SQLFeatureNotSupportedException if
     *                                            <code>DatabaseMetaData.supportsMultipleOpenResults</code>
     ...
     * flag if the SQL statement is not an <code>INSERT</code> statement, or an SQL
     ...
     *                                            given constant is not one of those
     ...
     * driver will ignore the array if the SQL statement is not an
     ...
     *                      as <code>INSERT</code>, <code>UPDATE</code> or
     *                      <code>DELETE</code>; or an SQL statement that returns
     ...
     *                                         the timeout value that was specified
     *                                         by the {@code setQueryTimeout} method
     *                                         has been exceeded and has at least
     *                                         attempted to cancel the currently
     ...
     *                         the second argument supplied to this method is not a
     *                         <code>String</code> array whose elements are valid
     *                         column names, the method is called on a
     *                         <code>PreparedStatement</code> or
     *                         <code>CallableStatement</code>
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method
     ...
     *                          method <code>getGeneratedKeys</code>; one of the
     *                          following constants:
     ...
     * @exception SQLException                    if a database access error occurs,
     *                                            this method is called on a closed
     *                                            <code>Statement</code>, the second
     ...
     *         results
     * @exception SQLException if a database access error occurs, this method is
     *                         called on a closed <code>Statement</code>, the
     *                         elements in the <code>int</code> array passed to this
     *                         method are not valid column indexes, the method is
     ...
     * @exception SQLException if a database access error occurs, this method is
     *                         called on a closed <code>Statement</code>,the
     *                         elements of the <code>String</code> array passed to
     *                         this method are not valid column names, the method is
     *                         called on a <code>PreparedStatement</code> or
     *                         <code>CallableStatement</code>
     * @throws SQLFeatureNotSupportedException if the JDBC driver does not support
     *                                         this method
     ...
     * @since 1.6
     *
     * @see sandbox.java.sql.Statement#setPoolable(boolean) setPoolable(boolean)
     */
    ...
    /**
     * Specifies that this {@code Statement} will be closed when all its dependent
     * result sets are closed. If execution of the {@code Statement} does not
     * produce any result sets, this method has no effect.
     * <p>
     ...
     * statements, and statements that currently have open, dependent, result sets.
     *
    ...
    /**
     * Returns a value indicating whether this {@code Statement} will be closed when
     * all its dependent result sets are closed.
     * 
     * @return {@code true} if the {@code Statement} will be closed when all of its
     *         dependent result sets are closed; {@code false} otherwise
     * @throws SQLException if this method is called on a closed {@code Statement}
     * @since 1.7
     */
    ...
    /**
     * Submits a batch of commands to the database for execution and if all commands
     * execute successfully, returns an array of update counts. The
     * <code>long</code> elements of the array that is returned are ordered to
     * correspond to the commands in the batch, which are ordered according to the
     * order in which they were added to the batch. The elements in the array
     * returned by the method {@code executeLargeBatch} may be one of the following:
     * <OL>
     * <LI>A number greater than or equal to zero -- indicates that the command was
     * processed successfully and is an update count giving the number of rows in
     * the database that were affected by the command's execution
     ...
     * continuing to process commands or never continuing to process commands. If
     * the driver continues processing after a failure, the array returned by the
     * method <code>BatchUpdateException.getLargeUpdateCounts</code> will contain as
    ...
    default long executeLargeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        throw new SQLFeatureNotSupportedException(String.toDJVM("executeLargeUpdate not implemented"));
    }
     ...
     * <blockquote>
     * <table class="striped">
     * <caption>Examples of the conversion:</caption> <thead>
     * <tr>
     ...
     *           implementation of this method in order to meet the requirements of
     *           the underlying datasource.
     * @param val a character string
     * @return A string enclosed by single quotes with every single quote converted
    ...
    default String enquoteLiteral(String val) throws SQLException {
        return String.toDJVM("'" + val.replace(String.toDJVM("'"), String.toDJVM("''")) + "'");
    }
     ...
     * <li>Return a delimited identifier if {@code alwaysQuote} is {@code true}</li>
     * </ul>
     *
     * If {@code identifier} is not a simple SQL identifier, {@code identifier} will
     * be enclosed in double quotes if not already present. If the datasource does
     * not support double quotes for delimited identifiers, the identifier should be
     * enclosed by the string returned from
     * {@link DatabaseMetaData#getIdentifierQuoteString}. If the datasource does not
     * support delimited identifiers, a {@code SQLFeatureNotSupportedException}
     * should be thrown.
     * <p>
     ...
     *
     * @implSpec The default implementation uses the following criteria to determine
     *           a valid simple SQL identifier:
     *           <ul>
     *           <li>The string is not enclosed in double quotes</li>
     *           <li>The first character is an alphabetic character from a through
     *           z, or from A through Z</li>
     ...
     *           <ul>
     *           <li>{@code identifier} contains a {@code null} character or double
     *           quote and is not a simple SQL identifier.</li>
     *           <li>The length of {@code identifier} is less than 1 or greater than
     *           128 characters
     *           </ul>
     *           <blockquote>
     *           <table class="striped" >
     ...
     * @param alwaysQuote indicates if a simple SQL identifier should be returned as
     *                    a quoted identifier
    ...
    default String enquoteIdentifier(String identifier, boolean alwaysQuote) throws SQLException {
        ...
        if (len < 1 || len > 128) {
            throw new SQLException(String.toDJVM("Invalid name"));
        }
        if (Pattern.compile("[\\p{Alpha}][\\p{Alnum}_]*").matcher(identifier).matches()) {
            return alwaysQuote ? String.toDJVM("\"" + identifier + "\"") : identifier;
        }
        if (identifier.matches(String.toDJVM("^\".+\"$"))) {
            identifier = identifier.substring(1, len - 1);
        }
        if (Pattern.compile("[^\u0000\"]+").matcher(identifier).matches()) {
            return String.toDJVM("\"" + identifier + "\"");
        } else {
            throw new SQLException(String.toDJVM("Invalid name"));
        }
    }
     ...
     *           <li>The first character is an alphabetic character from a through
     *           z, or from A through Z</li>
     *           <li>The string only contains alphanumeric characters or the
     *           character "_"</li>
     *           <li>The string is between 1 and 128 characters in length
     *           inclusive</li>
     *           </ul>
     *
     *           <blockquote>
     ...
     *           <tr>
     *           <th scope="col">identifier</th>
     *           <th scope="col">Simple Identifier</th> </thead>
     *
     *           <tbody>
     *           <tr>
     *           <th scope="row">Hello</th>
     ...
     * occurrence of a single quote within the string will be replaced by two single
     * quotes.
     *
     * <blockquote>
     * <table class="striped">
     ...
     * @implNote JDBC driver implementations may need to provide their own
     *           implementation of this method in order to meet the requirements of
     *           the underlying datasource. An implementation of enquoteNCharLiteral
     *           may accept a different set of characters than that accepted by the
     *           same drivers implementation of enquoteLiteral.
     * @param val a character string
     * @return the result of replacing every single quote character in the argument
     *         by two single quote characters where this entire result is then
     *         prefixed with 'N'.
     * @throws NullPointerException if val is {@code null}
     * @throws SQLException         if a database access error occurs
     *
    ...
    default String enquoteNCharLiteral(String val) throws SQLException {
        return String.toDJVM("N'" + val.replace(String.toDJVM("'"), String.toDJVM("''")) + "'");
    }
}
