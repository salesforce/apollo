...
public interface Wrapper {
     ...
     * @throws sandbox.java.sql.SQLException If no object found that implements the interface
     * @since 1.6
     */
        <T> T unwrap(java.lang.Class<T> iface) throws sandbox.java.sql.SQLException;
     ...
     * @throws sandbox.java.sql.SQLException  if an error occurs while determining whether this is a wrapper
     * for an object with the given interface.
     * @since 1.6
     */
    boolean isWrapperFor(java.lang.Class<?> iface) throws sandbox.java.sql.SQLException;
