 ...
 * the {@code sandbox.java.sql} package, referred to as the JDBC core API,
 ...
 *
 * <h2>What the {@code sandbox.java.sql} Package Contains</h2>
 * The {@code sandbox.java.sql} package contains API for the following:
 * <UL>
 ...
 * </UL>
 *
 *     <h3>{@code sandbox.java.sql} and {@code javax.sql} Features Introduced in the JDBC 4.3 API</h3>
 * <UL>
 ...
 * </UL>
 *
 *     <h3>{@code sandbox.java.sql} and {@code javax.sql} Features Introduced in the JDBC 4.2 API</h3>
 * <UL>
 ...
 * </UL>
 *
 *     <h3>{@code sandbox.java.sql} and {@code javax.sql} Features Introduced in the JDBC 4.1 API</h3>
 * <UL>
 ...
 *
 * </UL>
 * <h3>{@code sandbox.java.sql} and {@code javax.sql} Features Introduced in the JDBC 4.0 API</h3>
 * <UL>
 *   <LI>auto sandbox.java.sql.Driver discovery -- no longer need to load a
 * {@code sandbox.java.sql.Driver} class via {@code Class.forName}
 ...
 *
 *
 * <h3>{@code sandbox.java.sql} and {@code javax.sql} Features Introduced in the JDBC 3.0 API</h3>
 * <UL>
 ...
 *   <LI>Addition of the {@code sandbox.java.sql.Types.DATALINK} data type --
 ...
 * </UL>
 *
 * <h3>{@code sandbox.java.sql} Features Introduced in the JDBC 2.1 Core API</h3>
 * <UL>
