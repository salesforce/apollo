 ...
 *
 */
public record GorgoneionParameters(Function<SignedAttestation, CompletableFuture<Boolean>> verifier, Clock clock,
                                   Duration registrationTimeout,
                                   Function<SignedNonce, CompletableFuture<Any>> attester) {
    ...
    public static class Builder {
        ...
        public GorgoneionParameters build() {
            return new GorgoneionParameters(verifier, clock, registrationTimeout, attester);
        }
