...
public class Node extends Member {
    ...
    public Node(CertWithKey identity, FirefliesParameters parameters,
    ...
    /**
     * Generate a new note for the member based on any previous note and previous accusations. The new note has a larger
     * epoch number the the current note.
     */
    void nextNote() {
        Note current = note;
