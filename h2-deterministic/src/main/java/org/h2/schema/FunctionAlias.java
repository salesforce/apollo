...
public final class FunctionAlias extends UserDefinedFunction {
    ...
    public static class JavaMethod implements Comparable<JavaMethod> {
        ...
        JavaMethod(Method method, int id) {
            ...
            if (paramCount > 0) {
                Class<?> paramClass = paramClasses[paramClasses.length - paramCount];
                if (SessionServices.class.isAssignableFrom(paramClass)) {
                    hasServicesParam = true;
                    paramCount--;
                }
            }
            if (paramCount > 0) {
        ...
        /**
         * Check if this function requires session services.
         *
         * @return if the function requires session services
         */
        ...
        private Object execute(SessionLocal session, Expression[] args, boolean columnList) {
            ...
            if (hasServicesParam && params.length > 0) {
