...
package org.miracl.core.BLS12443;
...
public class CONFIG_FIELD {
    ...
    public static final int MODBITS = 443; /* Number of bits in Modulus */
    public static final int PM1D2 = 1; /* Modulus mod 8 */
    public static final int MODTYPE = NOT_SPECIAL;
    public static final int QNRI = 0;
    public static final int RIADZ = -7;
    public static final int RIADZG2A = 1;
    ...
    public static final int FEXCESS = (((int)1 << 30) - 1); // BASEBITS*NLEN-MODBITS or 2^30 max!
}
