...
public class CONFIG_CURVE {
    ...
    public static final int CURVE_PAIRING_TYPE = BLS12;
    public static final int SEXTIC_TWIST = M_TYPE;
    public static final int SIGN_OF_X = NEGATIVEX;
    public static final int ATE_BITS = 78;
    public static final int G2_TABLE = 79;
    public static final int HTC_ISO = 0;
    public static final int HTC_ISO_G2 = 0;
