...
public class CONFIG_FIELD {
    ...
    public static final int MODBITS = 462; /* Number of bits in Modulus */
    public static final int PM1D2 = 1; /* Modulus mod 8 */
    public static final int MODTYPE = NOT_SPECIAL;
    public static final int QNRI = 1;
    ...
    public static final int FEXCESS = (((int)1 << 18) - 1); // BASEBITS*NLEN-MODBITS or 2^30 max!
}
