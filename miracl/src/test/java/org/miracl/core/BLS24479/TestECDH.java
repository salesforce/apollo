...
public class TestECDH { //
    ...
    public void testECDH() {
        ...
        if (CONFIG_CURVE.CURVETYPE != CONFIG_CURVE.MONTGOMERY) {
            ...
            if (ECDH.VP_DSA(sha, W0, M, CS, DS) != 0) {
                ...
                System.out.println("ECDSA Signature/Verification succeeded " + j);
            System.out.println("");
     ...
     * 
     * byte[] RAW=new byte[100]; RAND rng=new RAND();
     * 
     * rng.clean(); for (int i=0;i<100;i++) RAW[i]=(byte)(i);
     * 
     * rng.seed(100,RAW); ecdh(rng);
     * 
     * }
     */
}
