...
public class TesttimeMPIN192 {
    ...
    public void testtimeMPIN() {
        ...
        System.out.format(" %8.2f ms per iteration\n", dur);
        /*
         * g.copy(w); FP8 cr; iterations = 0; start = System.currentTimeMillis(); do {
         * cr = g.compow(s, r);
         * 
         * iterations++; elapsed = (System.currentTimeMillis() - start); } while
         * (elapsed < MIN_TIME * 1000 || iterations < MIN_ITERS); dur = (double)elapsed
         * / iterations; System.out.format("GT pow (compressed) - %8d iterations  ",
         * iterations); System.out.format(" %8.2f ms per iteration\n", dur);
         */
        iterations = 0;
        start = System.currentTimeMillis();
        do {
