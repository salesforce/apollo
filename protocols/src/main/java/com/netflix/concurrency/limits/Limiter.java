...
/**
 * Contract for a concurrency limiter. The caller is expected to call acquire()
...
public interface Limiter<ContextT> {
    ...
    interface Listener {
        ...
        /**
         * The operation failed before any meaningful RTT measurement could be made and
         ...
         * or hitting a timeout. Loss based {@link Limit} implementations will likely do
         * an aggressive reducing in limit when this happens.
         */
        void onDropped();
    }
