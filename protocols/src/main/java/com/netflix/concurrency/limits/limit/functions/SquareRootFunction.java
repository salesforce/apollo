...
/**
 * Specialized utility function used by limiters to calculate thredsholds using
 * square root of the current limit. Here we pre-compute the square root of
 * numbers up to 1000 because the square root operation can be slow.
 */
