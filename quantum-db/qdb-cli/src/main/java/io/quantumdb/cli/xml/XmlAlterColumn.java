...
public class XmlAlterColumn implements XmlOperation<AlterColumn> {
	...
	static XmlOperation convert(XmlElement element) {
		...
		Optional.ofNullable(attributes.get("nullable")).map(Boolean.TRUE.toString()::equals).ifPresent(operation::setNullable);
		return operation;
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof XmlAlterColumn)) return false;
		...
		if (this$newType == null ? other$newType != null : !this$newType.equals(other$newType)) return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "XmlAlterColumn(tableName=" + this.getTableName() + ", columnName=" + this.getColumnName() + ", newColumnName=" + this.getNewColumnName() + ", newType=" + this.getNewType() + ", nullable=" + this.getNullable() + ")";
	}
}
