...
public class XmlChangeset {
	static XmlChangeset convert(XmlElement element) {
		...
		for (XmlElement child : element.getChildren()) {
			if (child.getTag().equals("operations")) {
				...
				String description = child.getChildren().stream().filter(subChild -> subChild.getTag() == null).filter(subChild -> subChild.getText() != null).map(XmlElement::getText).collect(Collectors.joining());
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof XmlChangeset)) return false;
	...
	public java.lang.String toString() {
		return "XmlChangeset(id=" + this.getId() + ", author=" + this.getAuthor() + ", description=" + this.getDescription() + ", operations=" + this.getOperations() + ")";
	}
}
