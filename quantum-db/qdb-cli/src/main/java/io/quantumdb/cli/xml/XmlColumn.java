...
public class XmlColumn {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof XmlColumn)) return false;
		final XmlColumn other = (XmlColumn) o;
		if (!other.canEqual((java.lang.Object) this)) return false;
		if (this.isPrimaryKey() != other.isPrimaryKey()) return false;
		if (this.isAutoIncrement() != other.isAutoIncrement()) return false;
	...
	public java.lang.String toString() {
		return "XmlColumn(name=" + this.getName() + ", type=" + this.getType() + ", defaultExpression=" + this.getDefaultExpression() + ", primaryKey=" + this.isPrimaryKey() + ", autoIncrement=" + this.isAutoIncrement() + ", nullable=" + this.isNullable() + ")";
	}
}
