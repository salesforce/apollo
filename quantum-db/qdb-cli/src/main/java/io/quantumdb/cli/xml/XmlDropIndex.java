...
public class XmlDropIndex implements XmlOperation<DropIndex> {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof XmlDropIndex)) return false;
	...
	public java.lang.String toString() {
		return "XmlDropIndex(tableName=" + this.getTableName() + ", columnNames=" + java.util.Arrays.deepToString(this.getColumnNames()) + ")";
	}
}
