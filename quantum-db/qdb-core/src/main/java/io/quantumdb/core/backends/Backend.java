...
public interface Backend {
     ...
     *
     * @throws SQLException In case no connection to the database could be
     *                      established.
     */
    ...
    /**
     * Loads the current state of the database schema and its evolution from the
     * database.
     *
     * @return The current state of the database schema.
     *
     * @throws SQLException In case the database could not be reached, or queried
     *                      correctly.
     */
    State loadState() throws SQLException;

    /**
     * Persists the current state of the database schema and its evolution to the
     * database.
     *
