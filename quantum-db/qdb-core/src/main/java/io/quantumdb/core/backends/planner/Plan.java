...
public class Plan {
	...
	public String toString() {
		...
		for (int i = 0; i < toPrint.size(); i++) {
			...
			if (!dependencies.isEmpty()) {
				...
				builder.append(dependencies.stream().map(toPrint::indexOf).map(position -> position + 1).collect(Collectors.toList()));
			}
			builder.append("\n");
		}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this$refLog == null ? other$refLog != null : !this$refLog.equals(other$refLog)) return false;
		final java.lang.Object this$ghostTables = this.getGhostTables();
		final java.lang.Object other$ghostTables = other.getGhostTables();
		if (this$ghostTables == null ? other$ghostTables != null : !this$ghostTables.equals(other$ghostTables)) return false;
