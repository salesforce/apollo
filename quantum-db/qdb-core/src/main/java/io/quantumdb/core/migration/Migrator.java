...
public class Migrator {
	...
	public static class Stage {
		...
		void addVersion(Version version) {
			checkState(versions.isEmpty() || versions.contains(version.getParent()), "The specified Version\'s parent must be present in the Stage!");
		...
		public boolean equals(final java.lang.Object o) {
			...
			if (!(o instanceof Migrator.Stage)) return false;
		...
		public java.lang.String toString() {
			return "Migrator.Stage(type=" + this.getType() + ", versions=" + this.getVersions() + ", parent=" + this.getParent() + ")";
		}
	}
