...
public class VersionTraverser {
    ...
    public static Direction getDirection(Version from, Version to) {
        ...
        throw new IllegalArgumentException(
                "These are different versions but in the same generation: " + from + ", " + to);
    }
    ...
    public static List<Stage> verifyPathAndState(State state, Version from, Version to) {
        ...
        if (versions.isEmpty()) {
            ...
            checkState(atCorrectVersion,
                       "The database is not at version: \'" + from + "\' but at: \'" + versions + "\'.");
        }
    ...
    private static Optional<List<Version>> findPath(Version from, Version to, boolean traverseChildren,
