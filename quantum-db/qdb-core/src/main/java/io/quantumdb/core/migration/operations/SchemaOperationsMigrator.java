...
public class SchemaOperationsMigrator {
	...
	public SchemaOperationsMigrator(Catalog catalog, RefLog refLog) {
		...
		this.refLog = refLog;
		this.migrators = ImmutableMap.<Class<? extends SchemaOperation>, SchemaOperationMigrator<?>>builder().put(AddColumn.class, new AddColumnMigrator()).put(AddForeignKey.class, new AddForeignKeyMigrator()).put(AlterColumn.class, new AlterColumnMigrator()).put(CopyTable.class, new CopyTableMigrator()).put(CreateIndex.class, new CreateIndexMigrator()).put(CreateTable.class, new CreateTableMigrator()).put(DropIndex.class, new DropIndexMigrator()).put(DropTable.class, new DropTableMigrator()).put(DropColumn.class, new DropColumnMigrator()).put(DropForeignKey.class, new DropForeignKeyMigrator()).put(RenameTable.class, new RenameTableMigrator()).put(CreateView.class, new CreateViewMigrator()).put(DropView.class, new DropViewMigrator()).build();
	}
