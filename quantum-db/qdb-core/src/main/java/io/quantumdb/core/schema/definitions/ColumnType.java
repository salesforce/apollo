...
public class ColumnType {
	...
	public static enum Type {
		OID, UUID, CHAR, VARCHAR, TEXT, SMALLINT, INTEGER, BIGINT, DOUBLE, FLOAT, BOOLEAN, DATE, TIMESTAMP;
	}
	...
	public ColumnType(final Type type, final boolean requireQuotes, final String notation, final ValueGenerator valueGenerator, final ValueSetter valueSetter) {
		this.type = type;
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.isRequireQuotes() != other.isRequireQuotes()) return false;
		...
		if (this$notation == null ? other$notation != null : !this$notation.equals(other$notation)) return false;
		...
		if (this$valueGenerator == null ? other$valueGenerator != null : !this$valueGenerator.equals(other$valueGenerator)) return false;
		final java.lang.Object this$valueSetter = this.getValueSetter();
		final java.lang.Object other$valueSetter = other.getValueSetter();
		if (this$valueSetter == null ? other$valueSetter != null : !this$valueSetter.equals(other$valueSetter)) return false;
		return true;
	}
