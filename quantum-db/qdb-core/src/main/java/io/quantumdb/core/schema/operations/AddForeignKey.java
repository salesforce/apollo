...
public class AddForeignKey implements SchemaOperation {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof AddForeignKey)) return false;
		...
		if (this$referringTableName == null ? other$referringTableName != null : !this$referringTableName.equals(other$referringTableName)) return false;
		if (!java.util.Arrays.deepEquals(this.getReferringColumnNames(), other.getReferringColumnNames())) return false;
	...
	public java.lang.String toString() {
		return "AddForeignKey(referringTableName=" + this.getReferringTableName() + ", referringColumnNames=" + java.util.Arrays.deepToString(this.getReferringColumnNames()) + ", name=" + this.getName() + ", onDelete=" + this.getOnDelete() + ", onUpdate=" + this.getOnUpdate() + ", referencedTableName=" + this.getReferencedTableName() + ", referencedColumnNames=" + java.util.Arrays.deepToString(this.getReferencedColumnNames()) + ")";
	}
}
