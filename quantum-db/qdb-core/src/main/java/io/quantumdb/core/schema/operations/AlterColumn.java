...
public class AlterColumn implements SchemaOperation {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof AlterColumn)) return false;
		...
		if (this$hintsToDrop == null ? other$hintsToDrop != null : !this$hintsToDrop.equals(other$hintsToDrop)) return false;
		final java.lang.Object this$hintsToAdd = this.getHintsToAdd();
		final java.lang.Object other$hintsToAdd = other.getHintsToAdd();
		if (this$hintsToAdd == null ? other$hintsToAdd != null : !this$hintsToAdd.equals(other$hintsToAdd)) return false;
		...
		if (this$newColumnName == null ? other$newColumnName != null : !this$newColumnName.equals(other$newColumnName)) return false;
		...
		if (this$newColumnType == null ? other$newColumnType != null : !this$newColumnType.equals(other$newColumnType)) return false;
		...
		if (this$newDefaultValueExpression == null ? other$newDefaultValueExpression != null : !this$newDefaultValueExpression.equals(other$newDefaultValueExpression)) return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "AlterColumn(tableName=" + this.getTableName() + ", columnName=" + this.getColumnName() + ", hintsToDrop=" + this.getHintsToDrop() + ", hintsToAdd=" + this.getHintsToAdd() + ", newColumnName=" + this.getNewColumnName() + ", newColumnType=" + this.getNewColumnType() + ", newDefaultValueExpression=" + this.getNewDefaultValueExpression() + ")";
	}
}
