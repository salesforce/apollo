...
public class CreateView implements SchemaOperation {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof CreateView)) return false;
	...
	public java.lang.String toString() {
		return "CreateView(viewName=" + this.getViewName() + ", temporary=" + this.isTemporary() + ", recursive=" + this.isRecursive() + ", query=" + this.getQuery() + ")";
	}
}
