...
public class DropIndex implements SchemaOperation {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!java.util.Arrays.deepEquals(this.getColumns(), other.getColumns())) return false;
		return true;
	}
	...
	public java.lang.String toString() {
		return "DropIndex(tableName=" + this.getTableName() + ", columns=" + java.util.Arrays.deepToString(this.getColumns()) + ")";
	}
}
