...
public class JoinTable implements SchemaOperation {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this$sourceTables == null ? other$sourceTables != null : !this$sourceTables.equals(other$sourceTables)) return false;
		...
		if (this$sourceColumns == null ? other$sourceColumns != null : !this$sourceColumns.equals(other$sourceColumns)) return false;
		...
		if (this$joinConditions == null ? other$joinConditions != null : !this$joinConditions.equals(other$joinConditions)) return false;
	...
	public java.lang.String toString() {
		return "JoinTable(sourceTables=" + this.getSourceTables() + ", sourceColumns=" + this.getSourceColumns() + ", joinConditions=" + this.getJoinConditions() + ", targetTableName=" + this.getTargetTableName() + ")";
	}
}
