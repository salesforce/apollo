...
public class MergeTable implements SchemaOperation {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof MergeTable)) return false;
		...
		if (this$leftTableName == null ? other$leftTableName != null : !this$leftTableName.equals(other$leftTableName)) return false;
		...
		if (this$rightTableName == null ? other$rightTableName != null : !this$rightTableName.equals(other$rightTableName)) return false;
	...
	public java.lang.String toString() {
		return "MergeTable(leftTableName=" + this.getLeftTableName() + ", rightTableName=" + this.getRightTableName() + ", targetTableName=" + this.getTargetTableName() + ")";
	}
}
