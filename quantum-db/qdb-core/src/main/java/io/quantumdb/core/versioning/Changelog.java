...
public class Changelog {
	...
	public java.lang.String toString() {
		return "Changelog(root=" + this.getRoot() + ", idGenerator=" + this.idGenerator + ", lastAdded=" + this.getLastAdded() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this$lastAdded == null ? other$lastAdded != null : !this$lastAdded.equals(other$lastAdded)) return false;
		return true;
	}
