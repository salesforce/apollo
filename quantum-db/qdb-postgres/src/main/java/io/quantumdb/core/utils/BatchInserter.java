...
public class BatchInserter {
    ...
    public static BatchInserter insertInto(Connection connection, String refId,
    ...
    private BatchInserter(Connection connection, String refId, String... columnNames) throws SQLException {
        ...
        String parameters = Arrays.stream(columnNames).map(columnName -> "?").collect(Collectors.joining(", "));

        String names = Arrays.stream(columnNames).collect(Collectors.joining(", "));
