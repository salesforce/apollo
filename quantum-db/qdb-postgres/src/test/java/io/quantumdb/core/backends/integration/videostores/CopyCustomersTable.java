...
public class CopyCustomersTable {
    ...
    public static void performEvolution() throws SQLException, MigrationException {
        ...
        setup.getChangelog()
             .addChangeSet("test", "Michael de Jong", SchemaOperations.copyTable("customers", "customers_backup"));
    ...
    public void verifyTableStructure() {
        ...
        Table newCustomers = new Table(refLog.getTableRef(target, "customers_backup").getRefId()).addColumn(new Column(
                "id", integer(), IDENTITY, AUTO_INCREMENT, NOT_NULL))
                                                                                                 .addColumn(new Column(
                                                                                                         "name",
                                                                                                         varchar(255),
                                                                                                         NOT_NULL))
