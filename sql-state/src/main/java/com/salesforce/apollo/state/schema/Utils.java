...
final class Utils {
    ...
    static class DataSourcePool {
        ...
        private final LoadingCache<List<String>, BasicDataSource> cache = CacheBuilder.newBuilder()
                                                                                      .softValues()
                                                                                      .build(new CacheLoader<List<String>, BasicDataSource>() {
                                                                                          @Override
    ...
    static class DialectPool {
        ...
        final Map<List<String>, SqlDialect>       map  = new HashMap<>();
        ...
        SqlDialect get(DataSource dataSource) {
            ...
            try {
                ...
                List<String> key = ImmutableList.of(productName, productVersion);
