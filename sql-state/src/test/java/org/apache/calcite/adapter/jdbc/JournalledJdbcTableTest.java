...
public class JournalledJdbcTableTest {
    ...
    public void setupMocks() {
        ...
        Mockito.doReturn(relBuilder)
               .when(relBuilderFactory)
               .create(Mockito.same(relOptCluster), Mockito.same(relOptSchema));
        ...
        Mockito.doReturn(new SqlIdentifier(ImmutableList.of("wrongSchema", "theJournal"), null, new SqlParserPos(0, 0),
                null))
               .when(journalTable)
               .tableName();
