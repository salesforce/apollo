...
public abstract class Ed25519 {
    // -x^2 + y^2 == 1 +
    // 0x52036CEE2B6FFE738CC740797779E89800700A4D4141D8AB75EB4DCA135978A3 * x^2 *
    // y^2
    ...
    private static final int[]  B_x             = new int[] { 0x0325D51A, 0x018B5823, 0x007B2C95, 0x0304A92D,
                                                              0x00D2598E, 0x01D6DC5C, 0x01388C7F, 0x013FEC0A,
                                                              0x029E6B72, 0x0042D26D };
    private static final int[]  B_y             = new int[] { 0x02666658, 0x01999999, 0x00666666, 0x03333333,
                                                              0x00CCCCCC, 0x02666666, 0x01999999, 0x00666666,
                                                              0x03333333, 0x00CCCCCC, };
    private static final int[]  C_d             = new int[] { 0x035978A3, 0x02D37284, 0x018AB75E, 0x026A0A0E,
                                                              0x0000E014, 0x0379E898, 0x01D01E5D, 0x01E738CC,
                                                              0x03715B7F, 0x00A406D9 };
    private static final int[]  C_d2            = new int[] { 0x02B2F159, 0x01A6E509, 0x01156EBD, 0x00D4141D,
                                                              0x0001C029, 0x02F3D130, 0x03A03CBB, 0x01CE7198,
                                                              0x02E2B6FF, 0x00480DB3 };
    private static final int[]  C_d4            = new int[] { 0x0165E2B2, 0x034DCA13, 0x002ADD7A, 0x01A8283B,
                                                              0x00038052, 0x01E7A260, 0x03407977, 0x019CE331,
                                                              0x01C56DFF, 0x00901B67 };
    private static final byte[] DOM2_PREFIX     = Strings.toByteArray("SigEd25519 no Ed25519 collisions");
    private static final int[]  L               = new int[] { 0x5CF5D3ED, 0x5812631A, 0xA2F79CD6, 0x14DEF9DE,
    ...
    private static final int[]  P               = new int[] { 0xFFFFFFED, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,
    ...
    static {
        SCALAR_BYTES = SCALAR_INTS * 4;
        PRECOMP_POINTS = 1 << (PRECOMP_TEETH - 1);
        PRECOMP_MASK = PRECOMP_POINTS - 1;
        PUBLIC_KEY_SIZE = POINT_BYTES;
        SIGNATURE_SIZE = POINT_BYTES + SCALAR_BYTES;
    }
...
//            assert off == precompBase.length;
    ...
    public static boolean verifyPrehash(byte[] sig, int sigOff, byte[] pk, int pkOff, byte[] ctx, byte[] ph,
                                        int phOff) {
        byte phflag = 0x01;
    ...
    private static boolean checkContextVar(byte[] ctx, byte phflag) {
        return ctx == null && phflag == 0x00 || ctx != null && ctx.length < 256;
    }
