...
public class TickScheduler {
    public class Timer implements Comparable<Timer> {
        ...
        public Timer(String label, Duration duration, Runnable action) {
            this.label = label;
    ...
    public Timer schedule(String label, Runnable action, Duration duration) {
        Timer timer = new Timer(label, duration, action);
        scheduled.add(timer);
        return timer;
    }
