...
public class Utils {
    ...
    public static Object accessField(String fieldName, Object target, Class<?> targetClass)
    throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        Field field;
        try {
     ...
     * @throws ZipException
     */
    public static void explode(File zip, File dest, Map<String, String> map, Collection<String> extensions)
    ...
    public static InetAddress getAddress(NetworkInterface iface, boolean requireIPV4) {
        ...
        if (interfaceAddress == null) {
            ...
            String.format("Unable ot determine bound %s address for interface '%s'", requireIPV4 ? "IPV4" : "IPV4/6",
                          iface));
        }
     ...
     *              System.getProperty()
     */
    public static void replaceProperties(final InputStream in, final OutputStream out, final Map<String, String> props)
    throws IOException {
     ...
     *                     resource
     */
    public static InputStream resolveResource(Class<?> base, String resource, Map<String, String> properties)
    throws IOException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
     ...
     *                     resource
     */
    public static InputStream resolveResource(Class<?> base, String resource, Properties properties)
    throws IOException {
    ...
    public static URL resolveResourceURL(Class<?> base, String resource) throws IOException {
        try {
            ...
            LoggerFactory.getLogger(Utils.class)
                         .trace(
                         String.format("The resource is not a valid URL: %s\n Trying to find a corresponding file",
                                       resource));
