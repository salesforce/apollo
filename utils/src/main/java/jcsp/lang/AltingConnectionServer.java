...
public abstract class AltingConnectionServer<T> extends Guard implements ConnectionServer<T> {
     ...
     */
    private AltingChannelInput<ConnectionClientMessage<T>> altingChannel;
     ...
     */
    protected AltingConnectionServer(AltingChannelInput<ConnectionClientMessage<T>> altingChannel) {
     ...
     */
    protected AltingChannelInput<ConnectionClientMessage<T>> getAltingChannel() {
     ...
     */
    protected void setAltingChannel(AltingChannelInput<ConnectionClientMessage<T>> chan) {
        altingChannel = chan;
    }
