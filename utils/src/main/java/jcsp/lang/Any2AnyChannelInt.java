...
/**
 * This defines an interface for an <i>any-to-any</i> integer channel, safe for
 ...
 * {@link Channel#any2anyInt() <i>synchronising</i>},
 * {@link Channel#any2anyInt(jcsp.util.ints.ChannelDataStoreInt)
 * <i>buffered</i>}, {@link Channel#any2anyInt(int) <i>poisonable</i>} or
 * {@link Channel#any2anyInt(jcsp.util.ints.ChannelDataStoreInt,int)
 * <i>both</i>} <i>(i.e. buffered and poisonable)</i>.
 * </P>
 * <H2>Description</H2> <TT>Any2AnyChannelInt</TT> is an interface for a channel
