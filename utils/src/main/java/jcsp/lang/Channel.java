 ...
 * e.g. fixed size blocking FIFO ({@link jcsp.util.Buffer <i>here</i>}),
 * fixed size <i>overwrite-oldest-when-full</i> ({@link jcsp.util.OverWriteOldestBuffer <i>here</i>}),
 * fixed size <i>discard-when-full</i> ({@link jcsp.util.OverFlowingBuffer <i>here</i>}),
