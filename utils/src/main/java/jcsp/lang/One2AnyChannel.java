...
/**
 * This defines the interface for a <i>one-to-any</i> Object channel, safe for
 ...
 * {@link Channel#one2any() <i>synchronising</i>},
 * {@link Channel#one2any(jcsp.util.ChannelDataStore) <i>buffered</i>},
 * {@link Channel#one2any(int) <i>poisonable</i>} or
 * {@link Channel#one2any(jcsp.util.ChannelDataStore,int) <i>both</i>} <i>(i.e.
 * buffered and poisonable)</i>.
 * </P>
 * <H2>Description</H2> <TT>One2AnyChannel</TT> is an interface for a channel
 ...
 */
public interface One2AnyChannel<In, Out> {
    /**
