...
/**
 * This implements a one-to-any integer channel, safe for use by one writer and
 * many readers.
 * <H2>Description</H2> <TT>One2AnyChannelIntImpl</TT> is an implementation of a
 ...
 * taken care of by <TT>One2AnyChannelIntImpl</TT> -- user processes just read
 * from or write to it.
 * <P>
