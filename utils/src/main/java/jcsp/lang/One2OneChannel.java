 ...
 * {@link Channel#one2one() <i>synchronising</i>},
 * {@link Channel#one2one(jcsp.util.ChannelDataStore) <i>buffered</i>},
 * {@link Channel#one2one(int) <i>poisonable</i>} or
 * {@link Channel#one2one(jcsp.util.ChannelDataStore,int) <i>both</i>} <i>(i.e.
 * buffered and poisonable)</i>.
 * </P>
 * </P>
 * <H2>Description</H2> <TT>One2OneChannelImpl</TT> is an interface for a
 * one-to-one object channel. Multiple readers or multiple writers are not
 * allowed &ndash; these are catered for by {@link Any2OneChannel},
 * {@link One2AnyChannel} or {@link Any2AnyChannel}.
 * <P>
