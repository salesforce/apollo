...
/**
 * This defines the interface for a symmetric <i>one-to-one</i> integer channel.
 ...
 * {@link Channel#one2oneSymmetricInt() <i>synchronising</i>} channels are
 * currently supported.
 ...
 * <P>
 * </P>
 * These channels may be constructed by the
 * {@link Channel#one2oneSymmetricInt()}. Channel poisoning and buffering are
 * not currently supported for these channels.
 * </P>
 *
 * @see Alternative
 * @see One2OneChannel
...
public interface One2OneChannelSymmetricInt {
