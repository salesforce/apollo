...
/**
 * Interface for an Any2One channel that supports filtering operations at each
 * end.
 *
 * @see Any2OneChannel
 * @see ReadFiltered
 ...
 */
public interface FilteredAny2OneChannel<In, Out> extends Any2OneChannel<In, Out> {
    /**
